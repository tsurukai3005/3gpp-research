...
## 1B. 概念全体マップ — Section 5 の要素間関係とトレードオフ

本セクションでは、Section 5 に登場する概念がどのように連鎖し、UE と gNB の非対称性がどこに現れるかを図示する。Section 5 外の概念（BWP、PDCP、プロトコルスタック等）も関係性の理解に必要な範囲で含める。

### 1B.1 UE の「一生」— 電源 ON からデータ通信までの概念の登場順
...
### 1B.2 gNB と UE の非対称性 — 誰が何を決め、何に制約されるか
...
### 1B.8 まとめ: Section 5 を読むための3つの視点
